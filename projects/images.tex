...
To get started, review how to access the \href{http://stackoverflow.com/questions/4117530/sys-argv1-meaning-in-script}{\textcolor{blue}{command-line arguments}} that every program running on a computer can accept. Here is a small program, \href{}{\tt view.py}, that accepts a filename as a command-line argument.
...
You can get a \href{https://github.com/parrt/msan501/tree/master/projects/figures}{\textcolor{blue}{bunch of sample images}} that I use for these notes from github.
