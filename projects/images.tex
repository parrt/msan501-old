...
\subsection{Cryptic but simple}

First, let's do it the easy but cryptic way from the commandline. Go to the URL associated with your images project at github: 
...
\noindent Then, use the {\tt git clone }{\em URL} command as you see below, replacing {\tt parrt-images} with {\em yourid}-{\tt images}. You will have to type in your github user ID and password.

\begin{lstlisting}[style=BashInputStyle]
$ cd ~/msan501 #  assuming this is where you want the root of all of 501 projects
$ git clone https://github.com/USF-MSAN-2016/parrt-images.git
Cloning into 'parrt-images'...
...
$ cd images # after this command you are now in your repository
\end{lstlisting}

\subsection{Git with SourceTree}

The second way to do this is with a graphical tool. Download \href{https://www.sourcetreeapp.com/download/}{\textcolor{blue}{SourceTree}}. In SourceTree, choose {\tt File:New/Clone} and then {\tt Clone from URL}:

\scalebox{.3}{\includegraphics{figures/source-tree-choices.png}}

\noindent Then, paste the {\tt https}-prefix URL into SourceTree, and set {\tt Destination Path} to and appropriate location, such as {\tt /Users/userid/msan501/userid-images}:

\scalebox{.7}{\includegraphics{figures/source-tree-clone.png}}
...
\scalebox{.9}{\includegraphics{figures/pycharm-git.png}}
...
\begin{marginfigure}
\begin{center}
\scalebox{.8}{\includegraphics{figures/flip-proj-browser2.png}}
\end{center}
...
\scalebox{.8}{\includegraphics{figures/pycharm-git-add.png}}
...
\scalebox{.8}{\includegraphics{figures/commit-changes.png}}

PyCharm will bring up another dialog and you should click {\tt Push} to send files back to github.
...
By the way, PyCharm will ask you questions about adding files under {\tt .idea} directory. Don't add those to the repo! Say NO here:

\begin{center}
\scalebox{.6}{\includegraphics{figures/pycharm-auto-add.png}}
\end{center}
\end{callout}
