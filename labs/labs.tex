...
\vspace{40pt}{\large Terence Parr\\
parrt@cs.usfca.edu\\
{\large\tt \href{http://parrt.cs.usfca.edu}{http://parrt.cs.usfca.edu}}\\
The University of San Francisco}

\cut{
\begin{fullwidth}
{\Huge\allcaps~\\
Labs for Computational Analytics}

\vspace{40pt}{\Large Terence Parr}

{\large\tt parrt@cs.usfca.edu}
...
Welcome to MSAN501, the computational analytics boot camp at the University of San Francisco! This lab book collects all of the tasks you must complete by the end of the boot camp in order to pass.  The labs start out as very simple tasks or step-by-step recipes but then accelerate in difficulty, culminating with an interesting text analysis project. All projects are to be completed in Python 2.

This course is specifically designed for those that are not yet skilled programmers but explores many concepts from math and statistics in an empirical fashion rather than symbolically, as one would do in a math class. Consequently, this course is also be useful to programmers that would like to strengthen their understanding of numerical methods.

As you build more sophisticated models and programs later in your career, you will use many pre-existing libraries. To fully appreciate how they work, however, it's a good idea to build some of these library routines yourself. The labs start at the absolute beginning: generating a sequence of random numbers and computing some simple point statistics like mean and variance.
