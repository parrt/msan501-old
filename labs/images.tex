...
\begin{itemize}
\item Part I: {\normalfont\itshape Tasks 1-3}
\item Part II: {\normalfont\itshape Tasks 4-6}
\item Part III: {\normalfont\itshape Task 7}
\end{itemize}
...
\begin{alltt}
    ...
    from urllib2 import (Request, urlopen, UR
\end{alltt}
...
If you are using PyCharm, then you need to use the ``{\tt Edit configuration}'' dialog under the {\tt Run} menu.  All file names that we specify in the script parameters area, or from the command line, are relative to the {\em current working directory}. That is why we used {\tt cd} to change our working directory in the example above. For convenience, let's keep all of images and scripts in the same directory. For our purposes, let's assume that the directory is always {\tt\small /Users/YOURID/msan501/images} (Mac) or {\tt\small /home/YOURID/msan501/images} (Linux).
...
\newpage\section{3. Removing noise}
...
\marginnote{We will import file {\tt filter.py} into all of our future scripts. You have created your first useful library. {\bf Good job!} \scalebox{.55}{\bcsmbh}}

\newpage\section{5. Highlighting image edges}
...
\newpage\section{6. Negative image edges}
...
\begin{minipage}{0.8 \linewidth}
\makebox[\linewidth]{%
\scalebox{.3}{\includegraphics{figures/bonkers-bw-zoom.png}} \scalebox{.3}{\includegraphics{figures/bonkers-edges-zoom.png}} \scalebox{.3}{\includegraphics{figures/bonkers-sharp-zoom.png}}
}
...
\begin{minipage}{0.8 \linewidth}
\makebox[\linewidth]{%
\scalebox{.35}{\includegraphics{figures/phobos1.png}}
\scalebox{.35}{\includegraphics{figures/phobos1-edges.png}}\\
\scalebox{.35}{\includegraphics{figures/phobos1-sharp.png}}
}
...
\begin{minipage}{0.8 \linewidth}
\makebox[\linewidth]{%
\scalebox{.35}{\includegraphics{figures/jeep.png}}
\scalebox{.35}{\includegraphics{figures/jeep-edges.png}}\\
\scalebox{.35}{\includegraphics{figures/jeep-sharp.png}}
}
