...
\noindent {\bf Q}.  Imagine there is no symbolic solution to the area under the curve of $f(x) = sin(x) + \frac{1}{3} sin(3x)$ from $0..\pi$. How could you estimate the area? Hint: do you like playing darts?
