...
\scalebox{.3}{\includegraphics{figures/wage-murders.pdf}}
\scalebox{.3}{\includegraphics{figures/wage-murders-fit.pdf}}\\
...
\noindent \scalebox{.4}{\includegraphics{figures/wage-murders-cost-3d.pdf}}
\scalebox{.35}{\includegraphics{figures/wage-murders-heatmap.pdf}}
...
\noindent \scalebox{.35}{\includegraphics{figures/wage-murders-heatmap-trace1.pdf}}
\scalebox{.35}{\includegraphics{figures/wage-murders-heatmap-trace2.pdf}}

\noindent \scalebox{.35}{\includegraphics{figures/wage-murders-heatmap-trace3.pdf}}
